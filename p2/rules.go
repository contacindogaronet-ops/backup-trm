...
func (t *BinaryRadixTrie) Insert(ipNet *net.IPNet, tier byte) {
	...
	if ones == 0 {
		return // Mencegah 0.0.0.0/0 memblokir seluruh internet
	}
...
func IsAbsoluteWhitelisted(clean string) bool {
	whitelistKeywords := []string{
		...
		"measurementlab.net", "measurement-lab.org", "m-lab.org", "mlab.org",
...
// ForceSetDomainRule mengubah rule domain secara dinamis via perintah shell CLI
...
// ForceSetIPRule mengubah rule IP secara dinamis via perintah shell CLI
